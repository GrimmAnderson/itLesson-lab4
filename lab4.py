"""
Программа для анализа данных call-центра с использованием классов.
Реализует все требования: итераторы, перегрузка операций, наследование,
__setattr__, __getitem__, статические методы и генераторы.
"""
